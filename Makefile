# This Makefile is for the Acme::Matt::Daemon extension to perl.
#
...
#     ABSTRACT => q[MATT DAEMON]
#     AUTHOR => q[Robert Krimen <rkrimen@cpan.org>]
#     DIR => []
#     DISTNAME => q[Acme-Matt-Daemon]
#     NAME => q[Acme::Matt::Daemon]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Log::Syslog::Abstract=>q[0], ExtUtils::MakeMaker=>q[6.48], Proc::Daemon=>q[0] }
#     VERSION => q[0.01]
...
MAKE = make
FULLEXT = Acme/Matt/Daemon
BASEEXT = Daemon
PARENT_NAME = Acme::Matt
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Acme/Matt/Daemon.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Acme/Matt
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Acme/Matt
...
TO_INST_PM = lib/Acme/Matt/Daemon.pm

PM_TO_BLIB = lib/Acme/Matt/Daemon.pm \
...
DISTNAME = Acme-Matt-Daemon
DISTVNAME = Acme-Matt-Daemon-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Acme/Matt/Daemon.pm $(INST_MAN3DIR)/Acme::Matt::Daemon.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>MATT DAEMON</ABSTRACT>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Log-Syslog-Abstract" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Proc-Daemon" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Acme/Matt/Daemon.pm blib/lib/Acme/Matt/Daemon.pm 
